 ...
 */
public class Tile {
    protected static enum tileID { RED,GREEN,BLUE,ORANGE,PURPLE,WHITE,YELLOW,FOCUS,DELETED,FINGERFOCUS } 
    protected tileID id;     
    ...
    protected boolean inFingerFocus;
    ...
    public void draw(Graphics g){
        ...
        if (inFingerFocus){
            ImageIcon fingerFocusIcon = new ImageIcon();
            fingerFocusIcon.setImage(Game.imageLibrary.getImage(Tile.tileID.FINGERFOCUS));
            fingerFocusIcon.paintIcon(null,g,anim_col,anim_row);
        }  
