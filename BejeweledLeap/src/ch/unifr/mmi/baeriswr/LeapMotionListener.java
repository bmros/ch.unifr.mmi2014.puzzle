...
/*
 this class monitors user Leap Motion input on the game board
 */
public class LeapMotionListener extends MouseInputAdapter {
    ...
    public void currentFingerPosition(Vector avgPos) {
        ...
        //System.out.println("avg finger Pos x: "+xCord);
        //System.out.println("avg finger Pos y: "+yCord);

        //System.out.println("finger col: "+col);
        //System.out.println("finger row: "+row);
...
class SampleListener extends Listener {
	private LeapMotionListener gamePanel;
	
    public SampleListener(LeapMotionListener gamePanel) {
		this.gamePanel = gamePanel;
	}
        ...
        if (!frame.hands().isEmpty()) {
            ...
            if (!fingers.isEmpty()) {
               ...
               //                  + " fingers, average finger tip position: " + avgPos);
                ...
                gamePanel.currentFingerPosition(avgPos);
...
class Sample implements Runnable{
    ...
    public Sample(LeapMotionListener gamePanel) {
        // Create a sample listener and controller
        listener = new SampleListener(gamePanel);
